import { HttpConnectionType, HttpIntegrationType, HttpMethod, HttpRouteIntegration, HttpRouteIntegrationBindOptions, HttpRouteIntegrationConfig, IVpcLink, PayloadFormatVersion } from 'aws-cdk-lib/aws-apigatewayv2';
