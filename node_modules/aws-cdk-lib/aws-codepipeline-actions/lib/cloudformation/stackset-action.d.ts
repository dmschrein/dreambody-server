...
import { CommonCloudFormationStackSetOptions, StackInstances, StackSetDeploymentModel, StackSetParameters, StackSetTemplate } from 'aws-cdk-lib/aws-codepipeline-actions/lib/cloudformation/stackset-types';
