...
import { BuildEnvironment, BuildImageBindOptions, BuildImageConfig, IBindableBuildImage, IBuildImage, ImagePullPrincipalType, IProject } from 'aws-cdk-lib/aws-codebuild/lib/project';
