import { CfnVirtualGateway } from 'aws-cdk-lib/aws-appmesh/lib/appmesh.generated';
import { HealthCheck } from 'aws-cdk-lib/aws-appmesh/lib/health-checks';
import { ListenerTlsOptions } from 'aws-cdk-lib/aws-appmesh/lib/listener-tls-options';
import { GrpcConnectionPool, Http2ConnectionPool, HttpConnectionPool } from 'aws-cdk-lib/aws-appmesh/lib/shared-interfaces';
